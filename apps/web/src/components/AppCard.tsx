...
interface AppCardProps {
  ...
  onRequestOccupiedEntry?: (app: ToolkitApp) => void;
}

export function AppCard({ app, navigate, ctaLabelOverride, onRequestOccupiedEntry }: AppCardProps) {
