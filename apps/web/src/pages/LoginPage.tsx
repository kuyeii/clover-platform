...
export function LoginPage({ navigate }: { navigate: NavigateFn }) {
  ...
  return (
    <main className="legacy-portal-ui flex min-h-screen items-center overflow-x-hidden bg-gradient-to-br from-white via-slate-50 to-sky-50 px-4 py-8 text-slate-900 md:px-8">
