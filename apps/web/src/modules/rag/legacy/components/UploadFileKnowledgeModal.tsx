...
export function UploadFileKnowledgeModal({
  ...
  return createPortal(
    <>
      ...
      />
      <div
        className="fixed left-1/2 top-1/2 z-[110] flex max-h-[min(90vh,560px)] w-[min(calc(100vw-2rem),440px)] -translate-x-1/2 -translate-y-1/2 flex-col rounded-2xl border border-slate-200 bg-white shadow-panel "
        role="dialog"
        aria-modal="true"
