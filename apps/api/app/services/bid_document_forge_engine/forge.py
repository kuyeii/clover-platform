...
_LEGACY_BID_ROOT = get_api_settings().repo_root / "legacy" / "bid-generator"
_DEFAULT_TEMPLATE_PATH = Path(
    os.environ.get("BID_FORGE_TEMPLATE_PATH", str(_LEGACY_BID_ROOT / "gateway-out" / "templates" / "official_template_cn.docx"))
)
_PRO_ENGINE_ROOT = Path(os.environ.get("PRO_ENGINE_ROOT", str(_LEGACY_BID_ROOT)))
