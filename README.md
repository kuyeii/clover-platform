...
当前阶段已进入第 6-D：Portal 前端核心平台能力和 feedback 能力已切到 apps/api。Portal auth、users、app-usage、runtime apps、feedback 使用 `/api/v1/core`，app-usage WebSocket 使用 `/ws/core/app-usage`；当前仍保留 legacy 后端与 iframe 过渡模式。
